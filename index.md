...
venue: "Institute of Science and Technology Austria (ISTA)"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Am Campus 1 3400 Klosterneuburg"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "48.308909996716594"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "16.258195142162236"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "April 7-8, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 5:30 pm CET"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Tereza Belinova (ISTA)", "Marco Dalla Vecchia (ISTA)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Christa Walter (GloBIAS)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["data_carpentry_python@globias.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p>
The <strong><a href="https://www.globias.org/">Global BioImage Analysts’ Society (GloBIAS)</a></strong> aims to be a worldwide association that brings together all those interested in bioimage analysis. 
...
<p id="who">
  <strong>Who:</strong>
Participants for this workshop has been selected by the organizers via an application process.
</p>
...
<p id="where">
  <strong>Where:</strong>
  {{page.address}}.
  Get directions to pick-up point and institute with
  <a href="https://www.google.com/maps/d/viewer?mid=1RYuFGow1aTtF62UA7LWDFMSoZCjx3bA&ll=48.260813628407696%2C16.318184999999986&z=13">Google Maps</a>.
...
<p>
  <strong>Material for workshop:</strong>
  <ul>
...
<ul>
  <li>Virtual Environment managers (e.g. conda, pyenv etc...)</li>
  <li>A functional Python environment</li>
  <li>A text editor (e.g. VS Code, Sublime Text, Atom, NotePad etc...)</li>
  <li>Git</li>
</ul>
</p>
<p>
